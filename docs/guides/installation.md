...
<phive xmlns="https://phar.io/phive">
    <phar name="llaville/sarif-php-converters" version="^1.4" copy="false" />
</phive>
```
...
```shell
composer require bartlett/sarif-php-converters ^1.4
```
...
```shell
git clone -b 1.4 https://github.com/llaville/sarif-php-converters.git
```
