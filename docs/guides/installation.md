...
<phive xmlns="https://phar.io/phive">
    <phar name="llaville/sarif-php-converters" version="^1.7" copy="false" />
</phive>
```
...
```shell
composer require bartlett/sarif-php-converters ^1.7
```
...
```shell
git clone -b 1.7 https://github.com/llaville/sarif-php-converters.git
```
